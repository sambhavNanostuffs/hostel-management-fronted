        ...
        <div className="row">
          <div className="dashCards col-lg-3 col-sm-6 mt-3">
            <Card>
              ...
              <CardFooter>
                <Link to={this.state.employee}>Details</Link>
              </CardFooter>
            </Card>
          </div>
          <div className="col-lg-3 col-sm-6 mt-3">
            <Card>
              ...
              <CardFooter>
                <Link to={this.state.student}>Details</Link>
              </CardFooter>
            </Card>
          </div>
          <div className="col-lg-3 col-sm-6 mt-3">
            <Card>
              ...
              <CardFooter>
                <Link to={this.state.rooms}>Details</Link>
              </CardFooter>
            </Card>
          </div>
          <div className="col-lg-3 col-sm-6 mt-3">
            <Card>
              ...
              <CardFooter>
                <Link to={this.state.meals}>Details</Link>
              </CardFooter>
            </Card>
          </div>
        </div>
