            ...
            <AdminRoute
              ...
              component={() => (
                <Admin
                  ...
                  postMealbill={this.props.postMealbill}
                  ...
                  postSalary={this.props.postSalary}
                  deleteNotice={this.props.deleteNotice}
                  deleteComplaint={this.props.deleteComplaint}
                  deleteStudent={this.props.deleteStudent}
                  deleteSeatAllocation={this.props.deleteSeatAllocation}
                  fetchStudents={this.props.fetchStudents}
                  salaries={this.props.salaries}
                  complaints={this.props.complaints}
                  postEmployee={this.props.postEmployee}
                  deleteEmployee={this.props.deleteEmployee}
                  deleteMealbill={this.props.deleteMealbill}
                  meals={this.props.meals}
                  mealBills={this.props.mealBills}
                  fetchEmployees={this.props.fetchEmployees}
                  seatAllocation={this.props.seatAllocation}
